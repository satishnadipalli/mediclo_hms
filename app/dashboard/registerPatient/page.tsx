...
const PatientRegistrationForm = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    parentInfo: {
      ...
      motherPhone: "", // Added mother's phone
    },
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/patients/register`, {
        ...
        body: JSON.stringify({
          ...
          parentInfo: {
            ...
            motherName: formData.parentInfo.motherName, // Added mother's name
            motherphone: formData.parentInfo.motherPhone, // Added mother's phone (note: using 'motherphone' to match schema)
          },
          emergencyContact: {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/patients/register`, {
        ...
        body: JSON.stringify({
          ...
          parentInfo: {
            ...
            photo: formData.parentInfo.photo,
            motherName: formData.parentInfo.motherName, // Added mother's name
            motherphone: formData.parentInfo.motherPhone, // Added mother's phone
          },
          emergencyContact: {
            name: formData.emergencyContact.name,
            relation: formData.emergencyContact.relation,
